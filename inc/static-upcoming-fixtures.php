        ...
        if ($query->rowCount() == 0) {
            ...
            foreach($results as $key => $result) {
                ...
                $html .= "  <div class='upcoming-fixtures-tbl'>"
                     ...
                     . "                  <td class='country-flag'><img src='img/teams/" . $hometeam . ".png' alt='" . $hometeam . " team flag'></td>"
                     . "                  <td class='versus'>" . $timeplayed . "</td>"
                     . "                  <td class='country-flag'><img src='img/teams/" . $awayteam . ".png' alt='" . $awayteam . " team flag'></td>"
