        ...
        foreach($json_array as $key => $fixture)  {
            ...
            */
            if ($query -> execute() === FALSE) {    
                echo json_encode( $msg_arr[Failure] . " Index : " . $key . " Fixture : " . $fixtureno . " " . $homescore . " -v- " . $awayscore . " Result : " . $resultid);
                // exit;            
            } else {
                echo json_encode( $msg_arr[Success] . " Fixture : " . $fixtureno . " " . $homescore . " -v- " . $awayscore . " Result ID : " . $resultid);
            };
